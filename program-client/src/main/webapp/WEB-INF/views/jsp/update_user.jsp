                    ...
                    <div class="panel-body">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" name="job" id="job">
                                <option value="SENIOR_BAILIFF"
                                        <c:if test="${user.job == 'SENIOR_BAILIFF'}">selected</c:if>>Старший
                                    судебный исполнитель
                                </option>
                                <option value="BAILIFF" <c:if test="${user.job == 'BAILIFF'}">selected</c:if>>
                                    Судебный исполнитель
                                </option>
                                <option value="CLERK" <c:if test="${user.job == 'CLERK'}">selected</c:if>>
                                    Делопроизводитель
                                </option>
                                <option value="HEAD_OF_ARCHIVES"
                                        <c:if test="${user.job == 'HEAD_OF_ARCHIVES'}">selected</c:if>>Заведующий
                                    архивом
                                </option>
                            </select>
                        </div>
