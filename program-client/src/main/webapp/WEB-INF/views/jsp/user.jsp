...
<div class="container">
    ...
    <div class="row">
        <div class="col-md-12">
            <a href="${pageContext.request.contextPath}/user/add" role="button" class="btn btn-success">Добавить</a>
            <button type="button"
                    class="btn btn-info" data-toggle="modal"
                    data-target=".count-example-modal-lg">Подсчитать производства на странице
            </button>
            <a href="${pageContext.request.contextPath}/user/statistic" role="button" class="btn btn-success">Статистика</a>
        </div>
    </div>
                    ...
                    <div class="panel-body">
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="form-group">
                                    <form:label path="creditor">Взыскатель:</form:label>
                                    <form:input cssClass="form-control" path="creditor"/>
                                </div>
                                <div class="form-group">
                                    <form:label path="debtor">Должник:</form:label>
                                    <form:input cssClass="form-control" path="debtor"/>
                                </div>
                                <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <select id="result" name="result" class="form-control">
                                        ...
                                        <option
                                                <c:if test="${search.result eq 'Исполнено'}">selected</c:if> value="Исполнено">
                                            Исполнено
                                        </option>
                                        <option
                                        ...
                                        <option
                                                <c:if test="${search.result eq 'Иное'}">selected</c:if> value="Иное">Иное
                                        </option>
                                    </select>
                                </div>
                                <div class="form-group">
                                    <form:label path="date">Дата начала производства:</form:label>
                                    <form:input cssClass="form-control datepicker" path="date"/>
                                </div>
                            </div>
                            <div class="col-md-2">
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <a href="${pageContext.request.contextPath}/user" role="button" class="btn btn-danger">Очистить результаты поиска</a>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <table class="table table-striped">
                        ...
                        <c:forEach var="process" items="${processes}">
                            <tr>
                                ...
                                <td>
                                    <a href="${pageContext.request.contextPath}/user/update/${process.id}"
                                       role="button" class="btn btn-warning btn-large">Редактировать</a>
                                    <button data-id="${process.id}" type="button"
                                            class="delete-button-class btn btn-danger btn-large" data-toggle="modal"
...
<div class="modal fade count-example-modal-lg" tabindex="-1" role="dialog">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span
                        aria-hidden="true">&times;</span></button>
                <h4 class="modal-title">Количество производств</h4>
            </div>
            <div class="modal-body">
            </div>
            <p>&nbsp;&nbsp;&nbsp;&nbsp;Количество производств: <c:out value="${count}"/></p>
            <div class="modal-footer">
